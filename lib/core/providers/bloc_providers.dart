...
final homeBlocProvider = Provider((ref) {
  return HomeBloc(
...
final diaryBlocProvider = Provider((ref) {
  return DiaryBloc(
...
final calendarDayBlocProvider = Provider((ref) {
...
final profileBlocProvider = Provider((ref) {
  return ProfileBloc(
